...
submit.onclick = function(){
    ...
    // nom
    if (nom.value == ""){
        output1.innerHTML = "*Le nom n'est pas valide";
    ...
    // marque
    if (marque.value == ""){
        output5.innerHTML = "*La marque n'est pas valide";
    ...
    //  Type
    if (AdType.value == ""){
        output2.innerHTML = "*Le type n'est pas valide";
    ...
    if (prix.value.match(/^[1-9]{1,9}$/g)){
        ...
        output3.innerHTML = "*Le type n'est pas valide";
    ...
    if(rd1.checked==true ){
        ...
        output6.innerHTML = "*n'est pas valide";
        ctr6=false;
    }

    // date
    if (date.value == ""){
        output4.innerHTML = "*La date n'est pas valide";
